...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [AMapServices sharedServices].apiKey = @"1ddc405587b3d77c09dcfcc5ce23d059";
    [WXApi registerApp:@"wx6e13cfbc191bad24"];
    
    
    if (SERVER_TYPE == 1) {
        //appstore
        [Bugtags startWithAppKey:@"4d67e7d395970a1b7b29e500dde64248" invocationEvent:BTGInvocationEventNone];
    }
    if (SERVER_TYPE == 2) {
        //测试环境
        [Bugtags startWithAppKey:@"4d67e7d395970a1b7b29e500dde64248" invocationEvent:BTGInvocationEventBubble];
    }
    
    
    [UMConfigure initWithAppkey:@"5b29f0618f4a9d0dea000022" channel:@"App Store"];
